...
console.log(document.querySelector('body').querySelectorAll('.section'));
...
// /* message.textContent = 'Please accept our cookie'; */
// message.innerHTML =
//   'Please accept our cookie<btn class = "btn btn--close-cookie">Got it</btn>';
...
// console.log(document.documentElement.style.setProperty('--color-primary','tomato'));

// //Attributes
// const logo = document.querySelector('.nav__logo')
// console.log(logo.getAttribute('ab'));
